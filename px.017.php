...
{
    public static $PXFilePath;
    public static $Default;

    //
    // VERSION
    //
    public static function Version() {return "017";}
    ...
    public static function fn($str) {return new px_function($str);}

    // AS FUNCTION
    public static function asFunction($p, $def=NULL)
    {
    ...
    // XML MAKE DOC
    public static function XmlMakeDoc($xml, $options=NULL)
    {
        if (!$xml)
    ...
    public static function XmlNewDoc($options=NULL)
    {
        $doc = new DOMDocument();
...
class px_nodes extends pxObject
{
    ...
    public function __construct($px, $inNodes)
    {
        $this->px = $px;
